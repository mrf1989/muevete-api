import { AuthPrincipal, Controller, GET, PUT, POST, DELETE, RouteParam, RequestBody,
    Mandarine, ResponseParam, RequestParam  } from "../../deps.ts";
...
export class UsuarioController {
    ...
    @GET("/login-success")
    public loginUsuarioSuccess(@AuthPrincipal() usuario: Mandarine.Types.UserDetails) {
