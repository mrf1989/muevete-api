import { Controller, POST, PUT, RouteParam, RequestBody } from "../../deps.ts";
...
export class DorsalController {
    ...
    @PUT("/dorsal/:id")
    public async updateDorsal<T extends Dorsal>(@RouteParam("id") id: string, @RequestBody() payload: T) {
