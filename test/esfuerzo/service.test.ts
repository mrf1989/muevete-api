...
import { Esfuerzo, Dorsal, Evento } from "../../src/models/models.ts";
...
Rhum.testPlan("Testing Esfuerzo Service", () => {
    ...
    Rhum.testSuite("Operaciones de creación de esfuerzos", () => {
        ...
        Rhum.testCase("Permite la creación de eventos", async () => {   
            eventoRepository.stub("getEvento", () => { return evento });
            dorsalRepository.stub("getDorsal", () => { return dorsal });
            dorsalRepository.stub("getAll", () => { return [dorsal] });
            esfuerzoRepository.stub("getEsfuerzosTotales", () => { return 2456 });
        ...
        Rhum.testCase("Limita la creación de esfuerzos para eventos completados", async () => {   
            eventoRepository.stub("getEvento", () => { return evento });
            dorsalRepository.stub("getDorsal", () => { return dorsal });
            dorsalRepository.stub("getAll", () => { return [dorsal] });
            esfuerzoRepository.stub("getEsfuerzosTotales", () => { return 4642 });
            esfuerzoRepository.stub("createEsfuerzo", () => {});
